  ...
  return (
    <div className="fixed inset-x-0 top-0 z-40">
      <div className="mx-auto max-w-6xl px-6">
        <nav className="mt-6 flex items-center justify-between rounded-full border border-neutral-200/70 bg-white/60 px-4 py-2.5 shadow-[0_1px_0_#0000000d] backdrop-blur-md dark:border-neutral-800/70 dark:bg-black/40">
          <Link href="/" className="hidden md:flex items-center gap-2 font-semibold tracking-tight text-neutral-900 dark:text-neutral-100">
          ...
          <div className="flex items-center justify-center gap-8 md:hidden w-full">
            ...
            >
              <svg className="w-7 h-7 text-neutral-600 dark:text-neutral-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden items-center gap-6 md:flex">
            <Link
              href="/"
              className="relative text-sm text-neutral-600 transition hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white"
            >
              Home
              {pathname === "/" && (
