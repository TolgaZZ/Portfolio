        ...
        {posts.slice(0, 4).map((post) => {
          ...
          return (
            <Link href={`/${post.slug.current}`} key={post._id} className="group h-full">
              <article className="relative overflow-hidden rounded-2xl border border-neutral-800 bg-black/40 shadow-[0_1px_0_#0000000d] backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-2 h-[520px]">
